// ============================================================
// RK AUTOMOBILES - Bajaj Showroom Bike Catalogue
// ------------------------------------------------------------
// FEATURED models with real product photos.
// 'img' is the main card image. 'gallery' holds all real views.
// 'colors' lists ONLY the real colors each bike is actually
// available in (used in the booking dropdown).
// Prices shown are indicative ex-showroom prices (India).
// ============================================================
...
const BIKES = [
  ...
  },
  {
    ...
    gallery: [
      "images/bikes/ns200/glossy-ebony-black.jpg"
    ],
    colors: ["Glossy Ebony Black"],
    desc: "The original street-sport icon. Twin-projector LED headlamps and a 199.5 cc liquid-cooled engine in a naked streetfighter stance."
  },
  {
    id: "ns160",
    name: "Pulsar NS160",
  ...
  },
  {
    ...
    desc: "Aggressive new-gen Pulsar with a muscular tank, full-LED lighting and a punchy 249 cc oil-cooled motor."
  },
  {
    id: "n160",
    name: "Pulsar N160 2V",
    ...
    gallery: [
      ...
      "images/bikes/n160/right-side-2v.jpg"
    ],
    colors: ["Atlantic Blue", "Pearl Metallic White", "Brooklyn Black"],
    desc: "Sharp, connected and powerful. A 164.82 cc engine with smartphone connectivity and sharp streetfighter styling."
  },
  {
    id: "n1604v",
    name: "Pulsar N160 4V",
    ...
    colors: ["Atlantic Blue", "Pearl Metallic White", "Brooklyn Black"],
    desc: "The 4-valve N160 delivers stronger low-end torque and refined performance with full streetfighter styling."
  },
  {
    id: "ns125",
    name: "Pulsar NS125",
    ...
    gallery: [
      "images/bikes/ns125/black.jpg",
      "images/bikes/ns125/orange.jpg"
    ],
    colors: ["Black", "Orange"],
    desc: "The NS-series DNA in a lighter, friendlier package — perimeter frame, muscular tank and a sporty single-projector headlamp."
  },
  {
    id: "n125",
    name: "Pulsar N125",
    category: "Commuter-Sport",
    price: "₹93,698",
    cc: "124.45 cc",
    power: "11.8 bhp",
    mileage: "58 kmpl",
  ...
  },
  {
    ...
    gallery: [
      "images/bikes/pulsar125/right-side-2026.jpg"
    ],
    colors: ["Red", "Black"],
    desc: "India's favourite Pulsar. Sporty commuter with high mileage, sharp looks and the legendary Pulsar riding experience."
  },
  {
    id: "pulsar150",
    name: "Pulsar 150",
    ...
    gallery: [
      "images/bikes/pulsar150/right-side.jpg"
    ],
  ...
  },
  {
    ...
    desc: "The iconic Chetak returns as a premium electric scooter with retro-modern style and a long real-world range."
  }
];
...
// ONGOING OFFERS
// ------------------------------------------------------------
// To add / update an offer, edit an object below and it will
// automatically appear on the website. Keep at least one entry.
// ============================================================
const OFFERS = [
  {
    id: "durgapuja",
    ...
    headline: "इस दुर्गा पूजा हर बाइक खरीद पर 10 ग्राम 24K Gold जीतने का सुनहरा मौका!",
    desc: "इस दुर्गा पूजा, हर बाइक खरीद पर 10 ग्राम 24K Gold जीतने का सुनहरा मौका! Buy any Bajaj bike and scratch your card to win exciting guaranteed prizes!",
    steps: [
      { n: "1", t: "Buy a Bike", h: "1 बाइक खरीदें" },
      { n: "2", t: "Get a Scratch Card", h: "2 स्क्रैच कार्ड पाएं" },
      { n: "3", t: "Scratch & Win", h: "3 स्क्रैच कार्ड करें" },
      { n: "4", t: "Win Exciting Prizes", h: "4 शानदार इनाम जीतें" }
    ],
    prizes: ["10g 24K Gold", "10g Silver Coin", "Mixer Grinder", "Induction Cooktop", "Ceiling Fan", "Gas Stove (2 Burner)", "Smart Watch", "& More!"],
    perks: ["Low Down Payment", "Easy Finance", "Best Exchange Value", "Assured Gifts"],
    tag: "Mega Offer",
    gold: true,
    terms: "Guaranteed prize on every scratch card! Valid during Durga Puja. Subject to terms & conditions."
  },
  {
    id: "emi",
    title: "0% Easy EMI",
    sub: "Starting at just ₹3,999/mo",
    desc: "Ride home today with flexible zero/low-interest EMI plans and instant loan approval. Finance assistance available on all models.",
    tag: "Finance",
    alt: true,
  ...
  },
  {
    ...
    desc: "Trade in your old bike and get the best market value plus an extra exchange bonus on the entire Bajaj range.",
    tag: "Exchange",
    alt: true,
    terms: "Exchange value assessed at showroom. Subject to vehicle condition."
  },
  {
    id: "gifts",
    title: "Free Helmet + Accessories",
    sub: "Worth ₹1,500",
    desc: "Every bike bought this month gets a free ISI-certified helmet and accessories kit as a gift from RK Automobiles.",
    tag: "Gift",
    alt: false,
...
// Full current Bajaj catalogue (all current models, indicative ex-showroom)
